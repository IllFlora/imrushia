...
const { getUserTweets } = require('./twikit'); // ローカルの twikit フォルダを読み込む

// ▼ 必須：X.comから取得したヘッダー情報（開発者ツールで取得）
const headers = {
...
// ▼ 必須：Discord Bot のトークンと通知チャンネルIDを入力
const botToken = 'MTM5NTI5MDEyNDY5ODI1NTM2MQ.GTRQ7O.KdlphozNZew0hanhEfAwXwqyD5xTF6kD2W-bD8';
const channelId = '1395346272071979048';
